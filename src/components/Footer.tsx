        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Transformando a maneira como você gerencia suas finanças através de conversas simples no WhatsApp.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-600">
                <a href="mailto:contato@money.io" className="hover:text-primary">
                  contato@money.io
                </a>
              </li>
              <li className="text-gray-600">
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Money.io. Todos os direitos reservados.
            </p>
